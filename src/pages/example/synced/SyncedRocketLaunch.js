...
export default function SyncedRocketLaunch(props){
    ...
    const getCurrentCountdown = useFun( () => {
        return countdown
    }, [countdown])
    ...
    return <>
        <Card key={"with-callback"} style={{ width: '40rem', color: "#000" }}>
            <Card.Body>
                <Card.Title>With 'useCallback'</Card.Title>
                <Card.Text>
